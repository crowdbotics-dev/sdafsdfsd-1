"""
Django settings for sdafsdfsd_1 project.
...
WSGI_APPLICATION = 'sdafsdfsd_1.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "sdafsdfsd_1 API",
    "DESCRIPTION": "API documentation for sdafsdfsd_1 App",
    "VERSION": "v1",
}
